        ...
        if (req.body.privateKey === address) {
          res
            ...
            .json({
              success: false,
              message:
                "Looks like you entered the public address of my ethereum wallet!",
              status: challenges.nftUnlockChallenge,
            });
          ...
          res
            ...
            .json({
              success: false,
              message:
                "Looks like you entered the public key of my ethereum wallet!",
              status: challenges.nftUnlockChallenge,
            });
        } else {
          res
            ...
            .json({
              success: false,
              message:
                "Looks like you entered a non-Ethereum private key to access me.",
              status: challenges.nftUnlockChallenge,
            });
        }
      }
